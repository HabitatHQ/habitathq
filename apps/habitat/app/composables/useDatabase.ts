...
export function useDatabase() {
  return {
    ...
    deleteAllCheckinData: (): Promise<null> => sendToWorker({ type: 'DELETE_ALL_CHECKIN_DATA' }),
    deleteAllScribbles: (): Promise<null> => sendToWorker({ type: 'DELETE_ALL_SCRIBBLES' }),
    clearAppliedDefaults: (): Promise<null> => sendToWorker({ type: 'CLEAR_APPLIED_DEFAULTS' }),
    getDbInfo: (): Promise<DbInfo> => sendToWorker({ type: 'GET_DB_INFO' }),
    integrityCheck: (): Promise<string[]> => sendToWorker({ type: 'INTEGRITY_CHECK' }),
    ...
    createCheckinTemplate: (
      p: Omit<CheckinTemplate, 'id' | 'archived_at' | 'response_day_count' | 'question_count'>,
    ): Promise<CheckinTemplate> => sendToWorker({ type: 'CREATE_CHECKIN_TEMPLATE', payload: p }),
    updateCheckinTemplate: (
      p: Partial<CheckinTemplate> & { id: string },
    ): Promise<CheckinTemplate> => sendToWorker({ type: 'UPDATE_CHECKIN_TEMPLATE', payload: p }),
    ...
    createCheckinQuestion: (
      p: Omit<CheckinQuestion, 'id' | 'archived_at'>,
    ): Promise<CheckinQuestion> => sendToWorker({ type: 'CREATE_CHECKIN_QUESTION', payload: p }),
    updateCheckinQuestion: (
      p: Partial<CheckinQuestion> & { id: string },
    ): Promise<CheckinQuestion> => sendToWorker({ type: 'UPDATE_CHECKIN_QUESTION', payload: p }),
    ...
    upsertCheckinResponse: (
      ...
      sendToWorker({
        ...
        payload: { question_id, logged_date, value_numeric, value_text },
      }),
    ...
    getAllReminders: (): Promise<Reminder[]> => sendToWorker({ type: 'GET_ALL_REMINDERS' }),
    ...
    createCheckinReminder: (
      ...
      sendToWorker({
        type: 'CREATE_CHECKIN_REMINDER',
        payload: { template_id, trigger_time, days_active },
      }),
    ...
    createBoredActivity: (
      ...
      >,
    ): Promise<BoredActivity> => sendToWorker({ type: 'CREATE_BORED_ACTIVITY', payload: p }),
    ...
    deleteAllBoredData: (): Promise<null> => sendToWorker({ type: 'DELETE_ALL_BORED_DATA' }),
    getTodos: (): Promise<Todo[]> => sendToWorker({ type: 'GET_TODOS' }),
    createTodo: (
      p: Omit<
        Todo,
        | 'id'
