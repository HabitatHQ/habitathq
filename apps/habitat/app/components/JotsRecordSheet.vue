...
<template>
  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      ...
      <UButton :icon="resolveIcon('x-mark')" variant="ghost" color="neutral" size="sm" aria-label="Close recording" class="min-h-[44px] min-w-[44px]" :disabled="isRecording" @click="handleClose" />
    </div>
